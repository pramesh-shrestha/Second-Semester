...
public class Power2State implements RadiatorState
{
  ...
  {
    System.out.println("Turn up button pressed..."
        + "Now transitioning to Power3State from Power2State");
  ...
  {
    System.out.println("Turn down button pressed..."
        + "Now transitioning back to Power1State from Power2State");
